...
function startClassifictaion() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/tmnFtsArT/model.json',modelReady);
}
function modelReady() {
...
function gotResult(error, results) {
    if(error){
        ...
        document.getElementById("detected").style.fontFamily = 'Courier New'+","+'Courier'+","+'cursive';
        ...
        document.getElementById("voice").style.fontFamily = 'Courier New'+","+'Courier'+","+'cursive';
